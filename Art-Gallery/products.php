...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Gallery Store!</h1>
                    <p>I have the best Art images for my Muddu. No need to hunt around, I have all in one place.</p>
                </div>
            </div>
                    <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/oil/rural.jpg" alt="muddu" style= "height: 200px;
  width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/oil/princess.jpg" alt="muddu" style= "height: 200px;
  width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/oil/flower.jpg" alt="muddu" style= "height: 200px;
  width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                               <img src="img/oil/oil.jpg" alt="muddu" style= "height: 200px;
  width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/water/1-watercolor.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Water paint</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/water/8-watercolor.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Water face</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                               <img src="img/water/12-watercolor.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Buety Of Nature</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/water/4-watercolor.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Buety of Village</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/digital/4-fantasy.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>digital fantasy</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/digital/11-fantasy.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>fantasy pic</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/digital/IMG_20190906_134041.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Muddu</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/digital/muddu.jpg" alt="muddu" style= "height: 200px; width: 100%;">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bujji</h3>
